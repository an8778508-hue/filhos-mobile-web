import 'package:escola/core/components/custom_reactions/src/extensions/key.dart';
import 'package:flutter/material.dart';

import '../enums/box.dart';
import '../enums/reaction.dart';
...
class _ReactionButtonState<T> extends State<ReactionButton<T>> {
  ...
  @override
  void didUpdateWidget(covariant ReactionButton<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
    _selectedReaction = _isChecked ? widget.selectedReaction : widget.placeholder;
  }
